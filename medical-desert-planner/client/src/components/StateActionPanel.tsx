          ...
          <>
            ...
            <details className="rounded-md border px-3 py-2 text-xs">
              ...
              <div className="mt-2 space-y-2 text-muted-foreground">
                <p>
                  <strong className="text-foreground">Risk:</strong> 0.25 × AQI + 0.30 × solid fuel + 0.20 × tobacco +
                  0.25 × clinic capacity stress (population-weighted) from NFHS-5, PM2.5 readings, and facility catalog
                  evidence.
                </p>
                <p>
